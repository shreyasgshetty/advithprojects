            ...
            {FILTERS_CONFIG.map((filter) => {
              ...
              return (
                <button
                  ...
                  className={`group relative flex items-center gap-2 py-3 px-2.5 sm:px-3.5 text-xs font-mono tracking-wider uppercase transition-all whitespace-nowrap cursor-pointer ${
                    isActive
