...
export default function ProjectsHero({ totalProjects = '09' }) {
  ...
  return (
    <section className="relative overflow-hidden bg-slate-950 text-white pt-24 pb-14 sm:pt-28 sm:pb-16 lg:pt-36 lg:pb-20 border-b border-slate-800">
      ...
      <div className="absolute top-6 left-6 text-[11px] font-mono text-white/20 select-none hidden sm:flex items-center gap-1.5">
        <span className="text-red-500/60">+</span>
        <span>DRAWING SHEET // AP-ARCHIVE</span>
      </div>
      <div className="absolute top-6 right-6 text-[11px] font-mono text-white/20 select-none hidden sm:flex items-center gap-1.5">
        <span>GRID 40×40MM</span>
        <span className="text-red-500/60">+</span>
      </div>

      <div className="relative max-w-6xl mx-auto px-6 lg:px-8">
        {/* Breadcrumb Navigation & Sheet ID */}
        <motion.div
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span className="text-slate-400">Records 01—{totalProjects}</span>
          </div>

          <div className="hidden md:flex items-center gap-3 text-[11px] text-slate-400">
            <span>REGISTRATION // KA-BLR</span>
            <span>·</span>
            <span>PERIOD // 2021 — 2026</span>
          </div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-end">
          <div className="lg:col-span-8">
            ...
            >
              ...
              <span>PROJECTS // ARCHIVE REGISTER 01</span>
            </motion.div>
          ...
          >
            <div className="flex items-center justify-between pb-3 mb-3 border-b border-slate-800 text-[11px] uppercase tracking-wider text-slate-400">
              <span className="text-slate-300 font-semibold">SITE SPECIFICATION</span>
              <span className="text-red-400 font-bold">SPEC // AP-2026</span>
            </div>
